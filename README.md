...
Hierarchy.ancestors(from: ChildClass, to: AncestorClass) # Array of hashes of relations → Representing the ancestors hierarchy starting from the ChildClass until it reaches AncestorClass
```
