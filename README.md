...
Hierarchy.ancestors(from: ChildClass, to: AncestorClass) # Hashes of relations → Representing the ancestors hierarchy starting from the ChildClass until it reaches AncestorClass
```
